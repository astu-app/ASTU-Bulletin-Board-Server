...
namespace BulletInBoardServer.Services.Test.Services.Surveys;
...
public class SurveyServiceTest : DbInvolvingTestBase
{
    ...
    public void Vote_VoteInSurvey_CountersIncreaseCorrectly()
    {
        var votes = new SurveyVotes(new Dictionary<Guid, List<Guid>>
        {
            ...
            [Question_2_WithMultipleChoice_OfPublicSurvey_1_Id] =
                [Answer_4_OfPublicSurvey_1_Id, Answer_5_OfPublicSurvey_1_Id]
        });
    ...
    public void Vote_VoteInAnonymousSurvey_UserSelectionsAreNotSavedInDatabase()
    {
        var votes = new SurveyVotes(new Dictionary<Guid, List<Guid>>
        {
            ...
            [Question_2_WithMultipleChoice_OfAnonymousSurvey_1_Id] =
                [Answer_5_OfAnonymousSurvey_1_Id, Answer_6_OfAnonymousSurvey_1_Id]
        });
    ...
    public void Vote_SelectMultipleAnswersInSingleChoiceQuestion_Throws()
    {
        var votes = new SurveyVotes(new Dictionary<Guid, List<Guid>>
        {
            ...
            [Question_1_WithSingleChoice_OfPublicSurvey_1_Id] =
                [Answer_1_OfPublicSurvey_1_Id, Answer_1_OfPublicSurvey_1_Id],
    ...
    public void GetSurveyVoters_GetAnonymousSurveyVoters_CorrectResult()
    {
        ...
        var votes = new SurveyVotes(new Dictionary<Guid, List<Guid>>
        {
            ...
            [Question_2_WithMultipleChoice_OfAnonymousSurvey_1_Id] =
                [Answer_4_OfAnonymousSurvey_1_Id, Answer_5_OfAnonymousSurvey_1_Id]
        });
